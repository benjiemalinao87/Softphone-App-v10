...
app.use(cors({
  origin: ['http://localhost:3039', 'http://localhost:3040', 'http://localhost:3000', 'https://glowing-muskox-sharing.ngrok-free.app'],
...
app.use((req, res, next) => {
  const allowedOrigins = ['http://localhost:3039', 'http://localhost:3040', 'http://localhost:3000', 'https://glowing-muskox-sharing.ngrok-free.app'];
